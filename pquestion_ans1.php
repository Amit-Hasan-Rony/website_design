...
<?php
    ...
    $conn = mysqli_connect($servername, $username, $password, $dbname);
    $len=strlen($_SESSION['q_a_table']);//for q_a table.. initialized in the first page.................
    if($len<2){
...
//new line from here.................................................
   ...
   if(!empty($_POST['submit_q'])){
      ...
      if(strlen($question)>2)
         $sql="INSERT INTO $table_name (name,question)VALUES('$username','$question')";
      else
...
//all will be deleted.....................before that line.......................................................
   	echo "<div style=\"margin-left: 25px;margin-top: 25px;\">
                 <p style=\"color: red;margin-left: 20px;margin-top:5px;\"><strong style=\"margin-left:0px;\">Question No:</strong><strong style=\"margin-left: 55px;\">User Name<strong style=\"margin-left: 155px;\">Question or Answer</p></br>
            </div>";
  ...
  <div class="write_division" id="two">
    <ul >
      <li style="margin-left: 350px;">
        <form action="" method="post">
          <textarea rows="3" cols="60" name="ask_question" placeholder="                   Enter your Question"></textarea>
          <input name="submit_q" style="margin-top: -45px;margin-left: 50px;background: blue" type="submit" value="Submit question">
        </form>
      </li>
    </ul>
  </div>
...
<script type="text/javascript">
  ...
  if(flag2=="true"){
       if(q_flag==1){
           ...
           alert("this is  the red divition");
       }
