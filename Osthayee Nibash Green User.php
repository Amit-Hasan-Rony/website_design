...
<?php
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      if(strlen($room_description)<=3){
        $room_description="Nothing is found in the database";
      }
      $room_facilities=$row['room_facilities'];
      if(strlen($room_facilities)<=3){
        $room_facilities="Nothing is found in the database";
      }
      $room_image=$row['room_image'];
      $room_rent=$row['room_rent'];
      if(strlen($room_facilities)<=3){
        $room_rent="Nothing is found in the database";
      }
      //new code start here..................................................................for pic...............................
      $room_image=$row['room_image'];
  ...
  <form action="" method="post">
    ...
    <div class="main_content">
        ...
        <div class="room_image">
        	...
        	<img src="images/greenroom.png" style="margin-left: 180px;margin-top: 165px;position: absolute;" width="400px" height="375px">
        </div>
    ...
    <div class="room_facilities">
    	...
    	<p style="width: 40%;margin-left: 40px"> <?php echo $room_description;   ?> </p>
    </div>

    <div class="cost_owner">
    	<div class="room_cost">
    		<h2 style="margin-left: 75px;margin-top: 26px;">this is the cost for the selected room.</h2>
    		<h2 style="margin-left: 203px;color: red"> <?php echo $room_facilities;   ?> </h2>
    	</div>

    	<div class="owner_information">
    		<h2 style="margin-left: 829px;margin-top: 5px;position: absolute;">This is the owner Information</h2>
    		<p style="margin-left: 901px;margin-top: 39px;position: absolute;">Name:Amit hasan rony</p>
    		<p style="margin-left: 900px;margin-top: 74px;position: absolute;">Contact No:01551811949</p>
    		<p style="margin-left: 772px;position: absolute;margin-top: 111px;">Address:House E2/2 B.M.T.F Residential Area, Gazipur Shadar,Gazipur-1703</p>
    	</div>
    </div>
