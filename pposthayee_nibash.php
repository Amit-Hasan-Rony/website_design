...
<?php
    ...
    if(!isset($_SESSION['building_tracking']))
         $len=strlen($_SESSION['building_tracking']);
    else
       $len=0;
    if($len>1){
      $expected_building=$_SESSION['building_tracking'];
    }else{
        ...
        <div class="dropdown">
                    ...
                    <div class="dropdown-content" style="margin-left: 23px">
                        <?php 
                             ...
                             for ($i=0; $i <$count ; $i++) { 
                                echo "<a href=\"pposthayee_nibash.php?building_tracking=$building_name_array[$i]\">$building_name_array[$i]</a>";
                             }
                        ?>
                    </div>
                </div>
